...
<body style="background:#414A52;color:white">
    ...
    <?php
       ...
       $type1=$_POST['first-choice4'];
       $brand1=$_POST['second-choice4'];
       $car1=$_POST['third-choice4'];


       

       if((is_null($car1))||(is_null($type1))||(is_null($brand1)))
       {
      ...
      {
    ?>
       <tr><th>MODEL</th><td><?php echo $row1["carid"];?></font></td></tr>
       <tr><th>PRICE</th><td><?php echo $row1["price"];?></td></tr>
       <tr><th>MILEAGE</th><td><?php echo $row1["mileage"];?></tr>
       <tr><th>TORQUE</th><td><?php echo $row1["torq"];?></td></tr>
  	   <tr><th>0-100</th><td><?php echo $row1["c0to100"];?></td></tr>
