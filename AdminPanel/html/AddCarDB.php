...
if(!$con)
	...
	elseif((!empty($car_mod))&&(!empty($car_type))&&(!empty($car_brand))&&(!empty($car_price))&&(!empty($rURL))&&(!empty($iURL))&&(!empty($car_mile))&&(!empty($car_torq))&&(!empty($c0to100)))
	{
	  mysqli_select_db($con,"car");
      $query1="INSERT INTO car  (carid,type,brand,price,rating,review_url,image_url,mileage,torq,c0to100) VALUES ('$car_mod','$car_type','$car_brand','$car_price','$rat','$rURL','$iURL','$car_mile','$car_torq','$c0to100')";
